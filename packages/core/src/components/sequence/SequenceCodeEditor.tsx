...
export const SequenceCodeEditor = () => {
  const { mermaidCode, parseErrors, updateFromCode } = useSequenceStore();
  ...
  return (
    <div className="sequence-code-editor flex flex-col h-full bg-slate-900">
      {/* ヘッダー */}
